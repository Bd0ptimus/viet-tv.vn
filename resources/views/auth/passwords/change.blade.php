                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('auth.password.change') }}">
                            @csrf
                            <div class="row mb-3">
                                <label for="currentPassword" class="col-md-4 col-form-label text-md-end">Mật khẩu hiện tại</label>

                                <div class="col-md-6">
                                    <input id="currentPassword" type="text" class="form-control @error('currentPassword') is-invalid @enderror" name="currentPassword" value="{{ old('currentPassword') }}" required autocomplete="currentPassword" autofocus>
